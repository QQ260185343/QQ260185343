...
namespace UpLoad
{
    class UpLoadFiles
    {
        private static string FTPCONSTR = "ftp://192.168.31.177";//FTP的服务器地址，格式为ftp://192.168.1.234/。ip地址和端口换成自己的，这些建议写在配置文件中，方便修改
        private static string FTPUSERNAME = "admin";//我的FTP服务器的用户名
        private static string FTPPASSWORD = "admin";//我的FTP服务器的密码
